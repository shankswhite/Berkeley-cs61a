...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN Question 2
    if num_rolls == 0:
        score = score + max(opponent_score % 10, opponent_score // 10)
    else:
...
def is_swap(score0, score1):
    ...
    """
    # BEGIN Question 4
    if max(score0, score1) % 10 == min(score0, score1) // 10:
        if max(score0, score1) // 10 == min(score0, score1) % 10:
            return True
        else:
            return False
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 <= goal and score1 <= goal:
        if one_turn == 0:
            ...
            if score == 0:
                score1 = score1 + strategy0(score0, score1)
            score0 = score0 +score
            one_turn = other(one_turn)
        else:
            score = take_turn(strategy1(score1, score0), score0, select_dice(score0, score1))
            if score == 0:
                score0 = score0 + strategy1(score1, score0)
            score1 = score1 +score
            one_turn = other(one_turn)
